...
class LocalFileConverterSpec extends FlatSpec {
  ...
  it should "convert a text repository represented in local XML files to CEX" in pending/* {
    val cex =
  ...
  it should "build a text repository given a properties file for an XML repository" in pending/* {
  ...
  it should "convert a text repository of XML files to CEX given a properties file" in pending /*{
    val propFile = "jvm/src/test/resources/xmlrepository.properties"
